...
public class ArrayUtilsTest {
    ...
    @Test
    public void testCountOfWithTargetNotInArray() {
        assertEquals(0, ArrayUtils.countOf(new int[]{1, 3, 5, 7, 9}, 2));
    }

    @Test
    public void testCountOfWithMultipleInstancesOfTargetInArray() {
        assertEquals(2, ArrayUtils.countOf(new int[]{1, 3, 5, 7, 9, 1}, 1));
    }
